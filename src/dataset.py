...
class BengaliDatasetTrain:
    ...
    def __getitem__(self, item):                                          # gets item indexes
        ...
        image = np.transpose(image, (2, 0, 1)).astype(np.float32)  # transpose image to fit torchvision models, exchange RGB channels (2,0,1).check how torchvision models expects the images
        return {
